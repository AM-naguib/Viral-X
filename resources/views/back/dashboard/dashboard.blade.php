    ...
    <div class="container">
        <div class="row">
            <div class="col-5 p-5 m-5">
                ...
                <p>Please <a style="text-decoration: underline;color:blue" href="{{ route('front.pricing') }}">subscribe</a> to use all features.</p>
            </div>
        </div>
    </div>
    @else
                                ...
                                <ul class="list-group list-group-flush list my--3">
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto"> <a href="#" class="avatar"><img class="rounded"
                                                        alt="Image placeholder"
                                                        src="{{ asset('assets') }}/img/team/profile-picture-1.jpg"></a>
                                            </div>
                                            ...
                                            <div class="col text-end"><a href="#"
                                                    class="btn btn-sm btn-secondary d-inline-flex align-items-center"><svg
                                                        class="icon icon-xxs me-2" fill="currentColor"
                                                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd"
                                                            d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z"
                                                            clip-rule="evenodd"></path>
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto"> <a href="../users.html" class="avatar"><img
                                                        ...
                                                        src="{{ asset('assets') }}/img/team/profile-picture-2.jpg"></a>
                                            </div>
                                            <div class="col-auto ms--2">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto"> <a href="#" class="avatar"><img
                                                        class="rounded-circle" alt="Image placeholder"
                                                        src="{{ asset('assets') }}/img/team/profile-picture-3.jpg"></a>
                                            </div>
                                            <div class="col-auto ms--2">
                                    ...
                                    <li class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            <div class="col-auto"> <a href="#" class="avatar"><img
                                                        class="rounded-circle" alt="Image placeholder"
                                                        src="{{ asset('assets') }}/img/team/profile-picture-4.jpg"></a>
                                            </div>
                                            <div class="col-auto ms--2">
                            ...
                            <div class="d-flex align-items-center justify-content-between border-bottom pb-3">
                                <div>
                                    <div class="h6 mb-0 d-flex align-items-center"><svg
                                            class="icon icon-xs text-gray-500 me-2" fill="currentColor"
                                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                                ...
                                <div><a href="#" class="d-flex align-items-center fw-bold">#755 <svg
                                            class="icon icon-xs text-gray-500 ms-1" fill="currentColor"
                                            viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd"
                        ...
                        <div class="card-body py-4">
                            ...
                            <div class="row align-items-center mb-4">
                                ...
                                <div class="col">
                                    <div class="progress-wrapper">
                                        <div class="progress-info">
                                            <div class="h6 mb-0">Japan <span
                                                    class="text-gray-500 font-small">(56.022)</span>
                                            </div>
                            ...
                            <div class="row align-items-center mb-4">
                                ...
                                <div class="col">
                                    <div class="progress-wrapper">
                                        <div class="progress-info">
                                            <div class="h6 mb-0">Italy <span
                                                    class="text-gray-500 font-small">(48.019)</span>
                                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="progress-wrapper">
                                        <div class="progress-info">
                                            <div class="h6 mb-0">Sweden <span
                                                    class="text-gray-500 font-small">(26.016)</span>
                                            </div>
