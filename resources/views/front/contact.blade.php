        ...
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
            <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    ...
                    <p class="mt-6 text-lg leading-8 text-gray-300">We'd love to hear from you! Whether you have a question, a comment, or just want to say hello, we're here and ready to chat. Feel free to reach out to us using any of the methods below:
                    </p>
                    <dl class="mt-10 space-y-4 text-base leading-7 text-gray-300">
                        ...
                        <div class="flex gap-x-4">
                            ...
                            <dd><a class="hover:text-white" href="tel:+201016631837">+201016631837</a></dd>
                        </div>
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                            ...
                            <dd><a class="hover:text-white" href="mailto:hello@example.com">naguibyou@gmail.com</a></dd>
                        </div>
                    </dl>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="phone-number" class="block text-sm font-semibold leading-6 text-white">Phone
                                number</label>
                            <div class="mt-2.5">
                                <input type="tel" name="phone_number" id="phone-number" autocomplete="tel"
                                    class="block w-full rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="sm:col-span-2">
